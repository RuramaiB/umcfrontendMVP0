...
export default {
  ...
  methods:{
    async fetchUser(){
      ...
      this.loading = true;
      const URL = "http://13.127.105.64:7210/api/v1/auth/getUserByMembershipNumber/" + localStorage.membershipNumber;
      await axios.get(URL,{
    ...
    async updateAdminHandler(){
      this.errors = {};
        ...
        try{
        await axios.put('http://13.127.105.64:7210/api/v1/auth/updateAdminByMembershipNumber/' + localStorage.membershipNumber,{
